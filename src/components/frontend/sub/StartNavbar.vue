...
import logo from '@/assets/frontend/img/aradan_logo.png'
...
<template>
    <nav class="navbar navbar-expand-lg p-0">
        ...
        <RouterLink to="/" class="navbar-brand" title="Aradan Template by AppSeed"
            ><img class="animate__animated animate__heartBeat animate__infinite	infinite animate__slow" :src="logo" alt="" />
        </RouterLink>
        ...
        >
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <RouterLink to="/women" class="nav-link"  title="Women"
                    >Women</RouterLink>
                </li>
                <li class="nav-item">
                <RouterLink to="/kid" class="nav-link" title="Kids"
                    >Kids</RouterLink>
                </li>
                <li class="nav-item">
